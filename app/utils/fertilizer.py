fertilizer_dic = {
        'NHigh': """<u>The N value of soil is high and might give rise to weeds.</u>
        ...
        <br/>5. <i>Use mulch (wet grass) while growing crops</i> - Mulch can also include sawdust and scrap soft woods<br/><br/>""",

        'Nlow': """<u>The N value of your soil is low.</u>
        <br/> Please consider the following suggestions:
        ...
        'NOk' : """<u>The N value for your soil is perfect for this crop.</u><br/><br/>""",
        
        'PHigh': """<u>The P value of your soil is high.</u>
        <br/> Please consider the following suggestions:
        ...
        <br/>5. Use crop rotations to decrease high phosphorous levels<br/><br/>""",

        'Plow': """<u>The P value of your soil is low.</u>
        <br/> Please consider the following suggestions:
        ...
        'POk' : """<u>The P value for your soil is perfect for this crop.</u><br/></br>""",


        'KHigh': """<u>The K value of your soil is high.</u>
        <br/> Please consider the following suggestions:
        ...
        'Klow': """<u>The K value of your soil is low.</u>
        <br/>Please consider the following suggestions:
        ...
        'KOk' : """<u>The K value for your soil is perfect for this crop.</u><br/></br>"""
    }